...
{
	ParamCheck pc("xo:dnmleabjkS:M:I:CDEJXZRAOvHh?-:sT:F:G:P:LpV", argc, argv);
	...
	while ( pc.check() ) {
		...
		case ParamCheck::match:
			...
			case 'J':
				...
				break;
			case 'X':  /* FIXME(bnoordhuis) Use e.g. "-JS" */
				hostLang = &hostLangJS;
				break;
			case 'R':
